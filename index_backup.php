...
<body class="antialiased">
    ...
    <div class="py-16 border-y border-slate-200 bg-white/50">
        <div
            class="max-w-7xl mx-auto px-12 flex flex-wrap justify-between items-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
        ...
        <div class="max-w-5xl mx-auto">
            <div class="glass-card p-12 md:p-20 relative overflow-hidden bg-white/80 border border-white/50 shadow-xl">
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-5xl font-black italic mb-6 text-slate-900">আপনার ব্যবসার জন্য স্পেশাল
                        অফার</h2>
                    <div class="flex flex-col items-center">
                        <span class="text-8xl font-black tracking-tighter text-slate-900">৳
                            <?php echo number_format(OFFER_PRICE, 0); ?>
                        </span>
    ...
    <footer class="py-24 border-t border-slate-200 text-center bg-slate-50">
        <div
            class="flex justify-center space-x-10 mb-12 grayscale opacity-40 hover:opacity-100 transition duration-500">
        ...
        <p class="text-[0.6rem] font-black uppercase tracking-[0.6em] text-slate-400">
            &copy;
            <?php echo date('Y'); ?> Bangla Chatbot. The Future is Automated.
        </p>
    </footer>
